...
`,g=n.p+"assets/logo-dark.svg";class f extends HTMLElement{constructor(){super(),this.hasRendered=!1,this.isOpen=!1,this.isHidden=!1,this.isScrolled=!1,this.lastScrollTop=0,this.eventListeners=[],this.eventListeners.push({element:document,event:"click",callback:this.handleClick.bind(this)},{element:window,event:"scroll",callback:this.handleScroll.bind(this)}),a(this.eventListeners)}connectedCallback(){this.hasRendered||(this.render(),this.hasRendered=!0)}disconnectedCallback(){c(this.eventListeners)}render(){this.innerHTML=o`
            <style>
                ${m}
            </style>
        ...
        `}handleClick(e){const t=e.target;t.closest("#navList li a")?this.updateOpen(!1):t.closest(".nav-toggle")?this.updateOpen(!this.isOpen):!t.closest("#navList")&&this.isOpen&&this.updateOpen(!1)}handleScroll(){const e=window.pageYOffset||document.documentElement.scrollTop;this.updateScrolled(e>f.SCROLL_COLOR_THRESHOLD),this.updateHidden(e>this.lastScrollTop),this.lastScrollTop=e<=0?0:e}updateOpen(e){this.isOpen!==e&&(this.isOpen=e,this.setAttribute(u.Open,String(e)))}updateHidden(e){this.isHidden!==e&&(this.isHidden=e,this.setAttribute(u.Hidden,String(e)),e&&this.updateOpen(!1))}updateScrolled(e){this.isScrolled!==e&&(this.isScrolled=e,this.setAttribute(u.Scrolled,String(e)))}}f.SCROLL_COLOR_THRESHOLD=10;const b=s`
    ${e.Service} {
        display: flex;
        flex-direction: column;
        text-align: center;
